        ...
        <div className={styles.container} id="preguntas">
            ...
            <div className={styles.preguntas__container}>
                <div className={styles.preguntas__title} onClick={()=>{togglePregunta(1)}}>
                    {pregunta === 1 ? <Image src="/images/arrow-up.svg" width={30} height={9}/> : <Image src="/images/arrow-down.svg" width={30} height={9}/>}
                    ¿Qué es Beneclub?
                    {pregunta === 1 ?
                ...
                <div className={styles.preguntas__title} onClick={()=>{togglePregunta(2)}}>
                    {pregunta === 2 ? <Image src="/images/arrow-up.svg" width={30} height={9}/> : <Image src="/images/arrow-down.svg" width={30} height={9}/>}
                ...
                <div className={styles.preguntas__title} onClick={()=>{togglePregunta(3)}}>
                    {pregunta === 3 ? <Image src="/images/arrow-up.svg" width={30} height={9}/> : <Image src="/images/arrow-down.svg" width={30} height={9}/>}
                ...
                <div className={styles.preguntas__title} onClick={()=>{togglePregunta(4)}}>
                    {pregunta === 4 ? <Image src="/images/arrow-up.svg" width={30} height={9}/> : <Image src="/images/arrow-down.svg" width={30} height={9}/>}
                    ¿Tiene costo?
                    {pregunta === 4 ?
                        <div className={styles.respuesta}>
                ...
                <div className={styles.preguntas__title} onClick={()=>{togglePregunta(5)}}>
                    {pregunta === 5 ? <Image src="/images/arrow-up.svg" width={30} height={9}/> : <Image src="/images/arrow-down.svg" width={30} height={9}/>}
                ...
                <div className={styles.preguntas__title} onClick={()=>{togglePregunta(6)}}>
                    {pregunta === 6 ? <Image src="/images/arrow-up.svg" width={30} height={9}/> : <Image src="/images/arrow-down.svg" width={30} height={9}/>}
